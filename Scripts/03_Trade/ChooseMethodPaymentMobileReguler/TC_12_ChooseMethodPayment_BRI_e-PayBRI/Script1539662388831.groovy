...
WebUI.click(findTestObject('Trade_Payment_Method/Click_Bank/BRI_Reguler/Click_11_BRI_e-PayBRI'))

CustomKeywords.'blj.common.report.Autoplaced.AppendToBlanjaAutoplacedReport'('BRI e-Pay BRI', true)